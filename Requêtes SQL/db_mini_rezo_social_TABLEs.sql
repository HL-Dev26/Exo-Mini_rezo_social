...
values  ('1', 'Zorro', 'zorb@example.com'),
		('2', 'Patchouli', 'patchouli@example.fr'),
        ('3', 'Eva', 'eva.stt@example.com');
        
insert into t_publication (pub_date, pub_titre, pub_contenu, user_id)
values 	('2024-11-23 14:30', 'Il fait beau', 'Quel beau soleil aujourd’hui !', '3'),
